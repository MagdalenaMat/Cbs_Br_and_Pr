...
library(plotly)
library(magrittr)
setwd("~/Desktop/s7s_Breast/data_after_decon/8_batches_with_EN_batch_corr/plots/Tcells/vulcano/")
...
for(i in names(to_GSEA)){
  ...
  m = plotd[plotd$gnames %in% c("CD40LG","CD69","CD8A","FASLG","ICOS","IFNG","GZMK",
...
subd = Geps[rownames(Geps) %in% c("GZMA","GZMB","ICOS","CD69","CTLA4","ITGAE",
                                  "FOXP3","IL10","TIGIT","IDO1","PDCD1","LAG3",
                                  "IL19","IL18RAP","CD8A","CD8B","CD151","CD9",
                                  "IL10","CTSB","CLIC1","CLIC3","ZAP70","TIMP4"),]
...
genes = c("act","migration","inh","Treg","Tcell_activation","diff")
...
path = setwd("~/Desktop/s7s_Breast/data_after_decon/8_batches_with_EN_batch_corr/plots/Tcells/dotplots/")
