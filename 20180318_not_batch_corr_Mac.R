...
rownames(gene_count2) = namesGEP
colnames(gene_count2) =colnames(filteredGEP[[1]])
...
ImGenes[["M2"]] = c("TGFB1", "TGFBI","CD14","NFKBIA")
ImGenes[["phagocytosis"]] = c("TREM2","CD47")
ImGenes[["phagocytosis2"]] =c("ANXA2","CTSD", "CTSA","CTSC","CTSD","CTSK","CTSO")
...
ImGenes[["MMPs"]] = c("MMP9","MMP13","TIMP1","TIMP2","MMP14","MMP11")
ImGenes[["oxidatie_stress"]] = c("FOXO3","BAX")
genes = c("ER_stress","antigen","TAP2","M2","phagocytosis","phagocytosis2", "glykolysis","STAT","IFN","apoptosis1","apaptosis2","MMPs","oxidatie_stress")
